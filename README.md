...
```
  ...
  -k, --kmer                          the KMER file in fasta format. Built-in SARS-CoV-2.kmer.fa will be used if this is not specified (string [=])
  -g, --genomes                       the genomes file in fasta format. Built-in SARS-CoV-2.genomes.fa will be used if this is not specified (string [=])
