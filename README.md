...
You can download KMER file and Genome file of viruses from http://opengene.org/uniquekmer/virus/index.html. This is generated by extracting unique KMERs for all genomes within a big FASTA (http://opengene.org/viral.genomic.fasta), which all NCBI complete RefSeq release of viral sequences that can be found from https://ftp.ncbi.nlm.nih.gov/refseq/release/viral/.
