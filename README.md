...
```
  ...
  -k, --kmer                          the KMER file in fasta format. data/SARS-CoV-2.kmer.fa will be used if KMER file (-k) nor Genomes file (-g) is specified (string [=])
  -g, --genomes                       the genomes file in fasta format. data/SARS-CoV-2.genomes.fa will be used if KMER file (-k) nor Genomes file (-g) is specified (string [=])
